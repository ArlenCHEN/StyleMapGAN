...
class FDCDataset(BaseDataset):
    def __init__(self, is_global, list_path, local_transforms, gray_ref_transforms, set='train', data_name='FDC',
                image_size=256,
                mean=None):
    ...
    def __getitem__(self, index):
        if self.is_global:
            ...
            # new_ref_gray_np = np.multiply(ref_mask, ref_gray_np).astype(np.float32) # Return this if the ref img needs to be masked
