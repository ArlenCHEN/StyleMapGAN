...
class FDCDataset(BaseDataset):
    def __init__(self, is_global, is_equal, is_temp, list_path, local_transforms, gray_ref_transforms, set='train', data_name='FDC',
                image_size=256,
                mean=None):
        super().__init__(is_global, is_equal, is_temp, list_path, set, data_name, image_size, mean)
    ...
    def __getitem__(self, index):
        if self.is_global:
            if self.is_equal:
                if self.is_temp:
                    overlaid_file, gt_file = self.files[index]
                    ...
                    return overlaid_rgb_np.copy(), gt_rgb_np.copy()
                else:
            ...
            return overlaid_rgb_np.copy(), ref_rgb_np.copy(), ref_gray_np.copy(), gt_rgb_np.copy(), gt_gray_np.copy(), left_gray_gt_np.copy(), left_gray_np.copy(), right_gray_gt_np.copy(), right_gray_np.copy(), mouth_gray_gt_np.copy(), mouth_gray_np.copy(), mask_np.copy()
